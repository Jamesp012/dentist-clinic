...
class EmailHelper {
    ...
    /**
     * Send welcome email to a self-registered patient
     */
    public static function sendPatientWelcome($email, $fullName, $username) {
        if (empty($email)) return false;

        $fromEmail = $_ENV['EMAIL_USER'] ?? 'dentalclinic@xn--maaodentalcare-snb.com';
        $subject = "Welcome to Maaño Dental Care - Account Created Successfully";
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
            ...
            <p>Your account has been created successfully at Maaño Dental Care. You can now access your patient portal to manage your information and book appointments.</p>
            
            <div style="background-color: #f9fafb; padding: 15px; border-radius: 8px; margin: 20px 0;">
                <p style="margin: 0; margin-bottom: 10px;"><strong>Your Account Info:</strong></p>
                <p style="margin: 0;"><strong>Username:</strong> ' . htmlspecialchars($username) . '</p>
            </div>
            
            <p>Please use the password you created during sign up to log in.</p>
            
            <div style="text-align: center; margin-top: 30px;">
                <a href="https://xn--maaodentalcare-snb.com" style="background-color: #14b8a6; color: white; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold;">Login to Patient Portal</a>
            </div>
