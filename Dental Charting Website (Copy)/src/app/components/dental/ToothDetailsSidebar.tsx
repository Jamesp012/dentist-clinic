...
interface ToothDetailsSidebarProps {
  ...
  onUpdateTooth: (id: number | string, updates: Partial<ToothData>) => void;
  onSelectTooth: (id: number | string) => void;
  allTeethIds: (number | string)[];
}
...
export function ToothDetailsSidebar({
  ...
  const getFDINumber = (id: number | string) => {
    if (typeof id === 'string') return id; // A-T
          ...
          >
            ...
            <div className="w-48 bg-slate-900 flex flex-col items-center py-6 text-slate-400 relative overflow-hidden shrink-0">
               ...
               <div className="flex-1 w-full overflow-y-auto no-scrollbar flex flex-col items-center gap-1">
                ...
                <div className="absolute left-16 top-1/2 -translate-y-1/2 flex flex-col gap-6 pointer-events-none">
